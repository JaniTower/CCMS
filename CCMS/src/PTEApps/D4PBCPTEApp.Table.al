...
table 62012 "D4P BC PTE App"
{
    ...
    trigger OnInsert()
    var
        PTEAppMgt: Codeunit "D4P BC PTE App Mgt";
    begin
        PTEAppMgt.InitializeId(Rec);
    end;
    ...
    var
        PTEAppMgt: Codeunit "D4P BC PTE App Mgt";
    begin
        PTEAppMgt.DeleteRelatedRecords(Rec);
    end;

    procedure ClearFieldsOnDevOpsChange()
    begin
